...
<br>
<script>
	function darkLight(){"dark"!=localStorage.toggled?($("head").append('<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/projetostudenten/Google-Drive-Index@v2.0.7.10/css/dark-mode.css" type="text/css" />'),localStorage.toggled="dark"):($('link[href="https://cdn.jsdelivr.net/gh/projetostudenten/Google-Drive-Index@v2.0.7.10/css/dark-mode.css"]').remove(),localStorage.toggled="")}$("#main").toggleClass(localStorage.toggled),"dark"==localStorage.toggled&&$("head").append('<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/projetostudenten/Google-Drive-Index@v2.0.7.10/css/dark-mode.css" type="text/css" />');
</script>
<div class="darkmode-toggle" onclick="darkLight()">🌓</div>
<footer class="text-muted"> <div class="container"> ${UI.credit ? '<p>Construído com <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-heart-fill" fill="red" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" /> </svg> pela <a href="https://github.com/projetostudenten/Google-Drive-Index" target="_blank">Equipe Studenten</a>, baseados em outros programas Open Source.</p>' : ''} <p>© ${UI.copyright_year} - ${UI.company_name} . <a href="https://www.youtube.com/watch?v=LXilEPmkoQY" target="_blank">Cópia não é roubo</a>.</p> 
<center><br>
